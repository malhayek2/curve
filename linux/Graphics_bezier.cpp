...
/*add select function when selecting 1 - 9 for each curve!*/
void keyboard(unsigned char c, int x, int y)
{
	switch (c) {
  		...
  		case '1':
			...
			break;
		case '2':
			last_selected_curve = 1;
			break;
		case '3':
			last_selected_curve = 2;
			break;
		case '4':
			last_selected_curve = 3;
			break;
		case '5':
			last_selected_curve = 4;
			break;
		case '6':
			last_selected_curve = 5;
			break;
		case '7':
			last_selected_curve = 6;
			break;
		case '8':
			last_selected_curve = 7;
			break;
		case '9':
			last_selected_curve = 8;
			break;
		default:
    return;
  }
...
void color_menu(int id) {
	/*&& */
	if (last_selected_curve != -1 && last_selected_curve < LINES.size()) {
		if (id == 1) {
			//purple
